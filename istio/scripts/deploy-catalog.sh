...
sed -i "s/userXX/${USERXX}/g" /home/demo/servicemesh/cloud-native-workshop-v2m3-labs/catalog/src/main/resources/application-openshift.properties
mvn clean install spring-boot:repackage -DskipTests -f /home/demo/servicemesh/cloud-native-workshop-v2m3-labs/catalog
...
oc start-build catalog-springboot --from-file /home/demo/servicemesh/cloud-native-workshop-v2m3-labs/catalog/target/catalog-1.0.0-SNAPSHOT.jar --follow

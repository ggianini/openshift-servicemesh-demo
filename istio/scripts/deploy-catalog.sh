...
sed -i "s/userXX/${USERXX}/g" /home/demo/openshift-servicemesh-demo/catalog/src/main/resources/application-openshift.properties
mvn clean install spring-boot:repackage -DskipTests -f /home/demo/openshift-servicemesh-demo/catalog
...
oc start-build catalog-springboot --from-file /home/demo/openshift-servicemesh-demo/catalog/target/catalog-1.0.0-SNAPSHOT.jar --follow
